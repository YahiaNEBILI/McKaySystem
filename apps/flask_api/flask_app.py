...
def _coerce_text_list(value: Any, *, field_name: str) -> Optional[List[str]]:
    ...
    if isinstance(value, (list, tuple)):
        ...
        return items or None
    raise ValueError(f"{field_name} must be a list of strings or comma-separated string")
...
@app.post("/api/recommendations/estimate")
@app.post("/api/recommendations/preview")
def api_recommendations_estimate() -> Any:
    """Estimate current savings impact for selected recommendations without persisting state."""
    try:
