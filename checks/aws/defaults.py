...
# CloudFront distributions checker defaults
CLOUDFRONT_LOOKBACK_DAYS: Final[int] = 14
CLOUDFRONT_MIN_DAILY_DATAPOINTS: Final[int] = 7
CLOUDFRONT_IDLE_P95_DAILY_REQUESTS_THRESHOLD: Final[float] = 1.0
CLOUDFRONT_MIN_AGE_DAYS: Final[int] = 7
CLOUDFRONT_MAX_FINDINGS_PER_TYPE: Final[int] = 50_000
